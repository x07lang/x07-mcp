...
| Trust packages have “38+ tests” for Merkle/TUF/rollback | **Partial** | `ext-mcp-trust@0.5.0` has 25 tests, and `packages/app/x07-mcp/0.4.0` has 12 publish/trust-pack tests (total 37). Coverage of Merkle/TUF/rollback is present. |
