...
- [`x07lang-mcp`](../../servers/x07lang-mcp/README.md) — official X07 ecosystem server with core editing tools plus capability-gated `x07.pkg.*`, `x07.wasm.*`, and `x07.service.*` tools
